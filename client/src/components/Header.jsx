...
export default function Header() {
  ...
  return (
    <header className='bg-whitecream shadow-md'>
        <div className='flex justify-between items-center max-w-6xl mx-auto p-3'>
            <Link to='/'>
                <h1 className='font-bold text-sm sm:text-xl flex flex-wrap'>
                    <span className='text-cream'>Mercury</span>
                    <span className='text-brownish'>Estate</span>
                </h1>
            </Link>
            <form onSubmit={handleSubmit} className='bg-slate-100 p-3 rounded-lg flex items-center'>
                ...
                <button>
                    <FaSearch className='text-brownish'/>
                </button>
            </form>
            <ul className='flex gap-4'>
                ...
                <Link to='/profile'>
                    { currentUser ? (
                        ...
                        <li className='sm:inline text-cream hover:underline font-semibold'>Sign in</li>
                    )}
                </Link>
